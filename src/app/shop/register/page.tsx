    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await addDoc(collection(db, "shops"), {
                ...
                taxStatus: challanImageUrl ? "paid" : "unpaid", // Auto-set based on challan image
                createdAt: new Date(),
                updatedAt: new Date(),
            })
            ...
            <main className="container mx-auto px-4 py-12">
                <div className="max-w-6xl mx-auto">
                    <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm card-hover">
                        <CardHeader className="border-b border-slate-100 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-t-2xl">
                            <div className="flex items-center space-x-6">
