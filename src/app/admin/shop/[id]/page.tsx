          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center space-x-2 lg:space-x-3 flex-shrink-0">
              <Button
                ...
                size="sm"
                className={`${
                  shop.taxStatus === "paid" ? "bg-red-600 hover:bg-red-700" : "bg-green-600 hover:bg-green-700"
              ...
              >
                ...
                <span className="hidden lg:inline">Mark as {shop.taxStatus === "paid" ? "Unpaid" : "Paid"}</span>
            ...
            <div className="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 flex-shrink-0">
                <Badge
                  ...
                  } text-sm lg:text-base px-3 lg:px-4 py-1 lg:py-2 font-semibold shadow-lg border`}
                >
